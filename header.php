              ...
              <div class="wrapper-search-contenido">
                ...
                <div class="closesearch" onclick="closesearch()">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 12.71 12.71">
                      <defs>
                          <style>.cls-6{fill:#706F6F;}</style>
                      </defs>
                      <g id="Capa_2" data-name="Capa 2">
                          <g id="Layer_1" data-name="Layer 1">
                              <path class="cls-6" d="M7.06,6.35l5.5-5.5a.48.48,0,0,0,0-.7.48.48,0,0,0-.7,0L6.35,5.65.85.15a.48.48,0,0,0-.7,0,.48.48,0,0,0,0,.7l5.5,5.5L.15,11.86a.48.48,0,0,0,0,.7.47.47,0,0,0,.35.15.5.5,0,0,0,.35-.15l5.5-5.5,5.51,5.5a.49.49,0,0,0,.35.15.47.47,0,0,0,.35-.15.48.48,0,0,0,0-.7Z" />
                          </g>
                      </g>
                  </svg>
                </div>
