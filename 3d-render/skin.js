...
// Pano2VR 6.1.6/17950
// Filename: skin jacuzzis v5.ggsk
// Generated 2020-05-17T18:48:44
...
function pano2vrSkin(player,base) {
	...
	player.addVariable('hidros', 1, 36);
	...
	this.addSkin=function() {
		...
		me._volver.appendChild(me._image_4);
		me._info.appendChild(me._volver);
		...
		me._responsive_configurador.logicBlock_size = function() {
			...
			if (me._responsive_configurador.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me._responsive_configurador.ggCurrentLogicStateSize == 0) {
					me._responsive_configurador.style.width='64%';
					me._responsive_configurador.style.height='120px';
					skin.updateSize(me._responsive_configurador);
				}
				else if (me._responsive_configurador.ggCurrentLogicStateSize == 1) {
					me._responsive_configurador.style.width='42%';
					me._responsive_configurador.style.height='120px';
					skin.updateSize(me._responsive_configurador);
				}
				else {
		...
		me._gris_claro.appendChild(me._rectangle_313);
		...
		me._gris_oscuro.appendChild(me._rectangle_311);
		...
		me._text_114.logicBlock_textcolor = function() {
			...
			if (me._text_114.ggCurrentLogicStateTextColor != newLogicStateTextColor) {
				...
				if (me._text_114.ggCurrentLogicStateTextColor == 0) {
					me._text_114__text.style.color="rgba(169,39,41,1)";
				}
				else {
		...
		me._x8.appendChild(me._rectangle_310);
		...
		me._text_113.logicBlock_textcolor = function() {
			...
			if (me._text_113.ggCurrentLogicStateTextColor != newLogicStateTextColor) {
				...
				if (me._text_113.ggCurrentLogicStateTextColor == 0) {
					me._text_113__text.style.color="rgba(169,39,41,1)";
				}
				else {
		...
		me._x16.appendChild(me._text_113);
		...
		me._x16.appendChild(me._rectangle_39);
		me._hidros0.appendChild(me._x16);
		el=me._x36=document.createElement('div');
		el.ggId="x36";
		el.ggDx=80;
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		...
		me._x36.logicBlock_scaling = function() {
			var newLogicStateScaling;
			if (
				((me.elementMouseDown['x36'] == true))
			)
			{
				newLogicStateScaling = 0;
			}
			...
			if (me._x36.ggCurrentLogicStateScaling != newLogicStateScaling) {
				me._x36.ggCurrentLogicStateScaling = newLogicStateScaling;
				me._x36.style[domTransition]='' + cssPrefix + 'transform 200ms ease 0ms';
				if (me._x36.ggCurrentLogicStateScaling == 0) {
					me._x36.ggParameter.sx = 0.9;
					me._x36.ggParameter.sy = 0.9;
					me._x36.style[domTransform]=parameterToTransform(me._x36.ggParameter);
				}
				else {
					me._x36.ggParameter.sx = 1;
					me._x36.ggParameter.sy = 1;
					me._x36.style[domTransform]=parameterToTransform(me._x36.ggParameter);
				}
			}
		}
		me._x36.onclick=function (e) {
			player.setVariableValue('hidros', Number("36"));
		}
		me._x36.onmouseout=function (e) {
			me.elementMouseDown['x36']=false;
			me._x36.logicBlock_scaling();
		}
		me._x36.onmousedown=function (e) {
			me.elementMouseDown['x36']=true;
			me._x36.logicBlock_scaling();
		}
		me._x36.onmouseup=function (e) {
			me.elementMouseDown['x36']=false;
			me._x36.logicBlock_scaling();
		}
		me._x36.ontouchend=function (e) {
			me.elementMouseDown['x36']=false;
			me._x36.logicBlock_scaling();
		}
		me._x36.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._x36.appendChild(me._text_112);
		...
		me._x36.appendChild(me._rectangle_38);
		me._hidros0.appendChild(me._x36);
		...
		me._no2.appendChild(me._rectangle_37);
		...
		hs='data:image/svg+xml;base64,'+
			...
			'';
		...
		me.__2.appendChild(me._rectangle_36);
		...
		me.__4.appendChild(me._rectangle_35);
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		me._basic.logicBlock_bordercolor = function() {
			...
			if (me._basic.ggCurrentLogicStateBorderColor != newLogicStateBorderColor) {
				...
				if (me._basic.ggCurrentLogicStateBorderColor == 0) {
					me._basic.style.borderColor="rgba(169,39,41,1)";
				}
				else {
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		me._hotspotson.logicBlock_position = function() {
			...
			if (me._hotspotson.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				if (me._hotspotson.ggCurrentLogicStatePosition == 0) {
					...
					me._hotspotson.style.bottom='134px';
				}
		...
		me._hotspotson.logicBlock_scaling = function() {
			...
			if (me._hotspotson.ggCurrentLogicStateScaling != newLogicStateScaling) {
				...
				if (me._hotspotson.ggCurrentLogicStateScaling == 0) {
					...
					me._hotspotson.ggParameter.sx = 1;
					me._hotspotson.ggParameter.sy = 1;
					me._hotspotson.style[domTransform]=parameterToTransform(me._hotspotson.ggParameter);
				}
			}
		}
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			'bmFsPSIjMDAwMDAwIiBmaWxsPSIjQzEyMDIwIiBjbGFzcz0iYWN0aXZlLXBhdGgiIGRhdGEtb2xkX2NvbG9yPSIjMDAwMDAwIi8+CiA8L2c+Cjwvc3ZnPgo=';
		...
		me._rectangle_20.appendChild(me._svg_6);
		me._hotspotson.appendChild(me._rectangle_20);
		...
		me._hotspotsoff.logicBlock_position = function() {
			...
			if (me._hotspotsoff.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				if (me._hotspotsoff.ggCurrentLogicStatePosition == 0) {
					me._hotspotsoff.style.right='15px';
					me._hotspotsoff.style.bottom='134px';
				}
				else if (me._hotspotsoff.ggCurrentLogicStatePosition == 1) {
					me._hotspotsoff.style.right='30px';
					me._hotspotsoff.style.bottom='134px';
				}
				else {
		...
		me._hotspotsoff.logicBlock_scaling = function() {
			...
			if (me._hotspotsoff.ggCurrentLogicStateScaling != newLogicStateScaling) {
				...
				if (me._hotspotsoff.ggCurrentLogicStateScaling == 0) {
					me._hotspotsoff.ggParameter.sx = 1;
					me._hotspotsoff.ggParameter.sy = 1;
		...
		me._rectangle_2.appendChild(me._rectangle_5);
		me._hotspotsoff.appendChild(me._rectangle_2);
		...
		me._information_horiz.appendChild(me._info_popup_close0);
		...
		me._container_text0.logicBlock_size = function() {
			...
			if (me._container_text0.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me._container_text0.ggCurrentLogicStateSize == 0) {
					...
					skin.updateSize(me._container_text0);
				}
				else {
		...
		me._information_vert.appendChild(me._info_popup_close);
		...
		me._container_text.logicBlock_size = function() {
			...
			if (me._container_text.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me._container_text.ggCurrentLogicStateSize == 0) {
					...
					skin.updateSize(me._container_text);
				}
				else {
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
	...
	me.callChildLogicBlocksHotspot_info0_changenode = function(){
		if(hotspotTemplates['info']) {
			var i;
			for(i = 0; i < hotspotTemplates['info'].length; i++) {
				if (hotspotTemplates['info'][i]._indicador && hotspotTemplates['info'][i]._indicador.logicBlock_scaling) {
					hotspotTemplates['info'][i]._indicador.logicBlock_scaling();
				}
			}
		}
	}
	me.callChildLogicBlocksHotspot_info0_mousedown = function(){
		if(hotspotTemplates['info']) {
			var i;
			for(i = 0; i < hotspotTemplates['info'].length; i++) {
				if (hotspotTemplates['info'][i]._bolita2 && hotspotTemplates['info'][i]._bolita2.logicBlock_scaling) {
					hotspotTemplates['info'][i]._bolita2.logicBlock_scaling();
				}
			}
		}
	}
	me.callChildLogicBlocksHotspot_info0_varchanged_infohotspots = function(){
		if(hotspotTemplates['info']) {
			var i;
			for(i = 0; i < hotspotTemplates['info'].length; i++) {
				if (hotspotTemplates['info'][i]._indicador && hotspotTemplates['info'][i]._indicador.logicBlock_scaling) {
	...
	me.callChildLogicBlocksHotspot_variaciones_changenode = function(){
		if(hotspotTemplates['variaciones']) {
			...
			for(i = 0; i < hotspotTemplates['variaciones'].length; i++) {
				...
				if (hotspotTemplates['variaciones'][i].__32 && hotspotTemplates['variaciones'][i].__32.logicBlock_alpha) {
					hotspotTemplates['variaciones'][i].__32.logicBlock_alpha();
				}
	...
	function SkinHotspotClass_info0(parentScope,hotspot) {
		var me=this;
		var flag=false;
		var hs='';
		...
		me._info0.onclick=function (e) {
			player.setVariableValue('info_w_picture', true);
			...
			skin._popup_image2.ggText=player.getBasePath()+""+me.hotspot.url;
			skin._popup_image2.ggSubElement.style.width = '0px';
			skin._popup_image2.ggSubElement.style.height = '0px';
			skin._popup_image2.ggSubElement.src='';
			skin._popup_image2.ggSubElement.src=skin._popup_image2.ggText;
		...
		me._info0.ondblclick=function (e) {
		...
		me._info0.appendChild(me._indicador);
		me.__div = me._info0;
	};
	function SkinHotspotClass_variaciones(parentScope,hotspot) {
		...
		els.className='ggskin ggskin_external';
		els.setAttribute('style','position: absolute;-webkit-user-drag:none;pointer-events:none;;');
		els.onload=function() {me.__32.ggUpdatePosition();}
		el.ggText=basePath + "assets/hidros36.png";
		els.setAttribute('src', el.ggText);
		els['ondragstart']=function() { return false; };
		player.checkLoaded.push(els);
		hs ='';
		...
		me.__32.logicBlock_alpha = function() {
			var newLogicStateAlpha;
			if (
				((player.getVariableValue('hidros') == 36))
			)
			...
			if (me.__32.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				me.__32.ggCurrentLogicStateAlpha = newLogicStateAlpha;
				me.__32.style[domTransition]='opacity 500ms ease 0ms';
				if (me.__32.ggCurrentLogicStateAlpha == 0) {
					me.__32.style.visibility=me.__32.ggVisible?'inherit':'hidden';
					me.__32.style.opacity=1;
				}
				else {
					setTimeout(function() { if (me.__32.style.opacity == 0.0) { me.__32.style.visibility="hidden"; } }, 505);
					me.__32.style.opacity=0;
				}
			}
		}
		me.__32.ggUpdatePosition=function (useTransition) {
			...
			var parentWidth = me.__32.clientWidth;
			var parentHeight = me.__32.clientHeight;
			var img = me.__32__img;
			var aspectRatioDiv = me.__32.clientWidth / me.__32.clientHeight;
			var aspectRatioImg = img.naturalWidth / img.naturalHeight;
			if (img.naturalWidth < parentWidth) parentWidth = img.naturalWidth;
			if (img.naturalHeight < parentHeight) parentHeight = img.naturalHeight;
			var currentWidth,currentHeight;
		...
		me._hidros1.appendChild(me.__32);
	...
	me.addSkinHotspot=function(hotspot) {
		...
		if (hotspot.skinid=='info') {
			hotspot.skinid = 'info';
			hsinst = new SkinHotspotClass_info0(me, hotspot);
			if (!hotspotTemplates.hasOwnProperty(hotspot.skinid)) {
				hotspotTemplates[hotspot.skinid] = [];
			}
			hotspotTemplates[hotspot.skinid].push(hsinst);
			me.callChildLogicBlocksHotspot_info0_changenode();;
			me.callChildLogicBlocksHotspot_info0_mousedown();;
			me.callChildLogicBlocksHotspot_info0_varchanged_infohotspots();;
		} else
		{
	...
	player.addListener('varchanged_hidros', function(args) { me._text_114.logicBlock_textcolor();me._rectangle_310.logicBlock_bordercolor();me._text_113.logicBlock_textcolor();me._rectangle_39.logicBlock_bordercolor();me._text_112.logicBlock_textcolor();me._rectangle_38.logicBlock_bordercolor();me._basic.logicBlock_bordercolor();me._text_19.logicBlock_textcolor();me._medio.logicBlock_bordercolor();me._text_18.logicBlock_textcolor();me._full.logicBlock_bordercolor();me._text_17.logicBlock_textcolor(); });
	player.addListener('varchanged_luces', function(args) { me._rectangle_37.logicBlock_bordercolor();me._svg_52.logicBlock_alpha();me._text_111.logicBlock_textcolor();me._rectangle_36.logicBlock_bordercolor();me._text_110.logicBlock_textcolor();me._rectangle_35.logicBlock_bordercolor();me._basic.logicBlock_bordercolor();me._text_19.logicBlock_textcolor();me._medio.logicBlock_bordercolor();me._text_18.logicBlock_textcolor();me._full.logicBlock_bordercolor();me._text_17.logicBlock_textcolor(); });
	...
	player.addListener('changenode', function(args) { me.callChildLogicBlocksHotspot_info0_changenode();me.callChildLogicBlocksHotspot_variaciones_changenode(); });
	player.addListener('mousedown', function(args) { me.callChildLogicBlocksHotspot_info0_mousedown(); });
	player.addListener('varchanged_infohotspots', function(args) { me.callChildLogicBlocksHotspot_info0_varchanged_infohotspots(); });
