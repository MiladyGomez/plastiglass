...
// Filename: skin asahi v2.ggsk
// Generated 2021-09-12T10:47:28
...
function pano2vrSkin(player,base) {
	...
	player.addVariable('Interfaz_1', 2, false);
	player.addVariable('infohotspots_1', 2, false);
	player.addVariable('planta', 2, false);
	player.addVariable('agarraderas', 2, true);
	var me=this;
	var skin=this;
	var flag=false;
	...
	this.addSkin=function() {
		...
		me._responsive_configurador.logicBlock_size = function() {
			...
			if (me._responsive_configurador.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me._responsive_configurador.ggCurrentLogicStateSize == 0) {
					me._responsive_configurador.style.width='60%';
					...
					me._responsive_configurador.style.width='40%';
					me._responsive_configurador.style.height='120px';
					setTimeout(function() {skin.updateSize(me._responsive_configurador);}, 1000);
				}
				else {
		...
		me._rectangle_317.logicBlock_bordercolor = function() {
			...
			if (me._rectangle_317.ggCurrentLogicStateBorderColor != newLogicStateBorderColor) {
				...
				if (me._rectangle_317.ggCurrentLogicStateBorderColor == 0) {
					me._rectangle_317.style.borderColor="rgba(50,180,182,1)";
				}
				else {
		...
		me._rectangle_315.logicBlock_bordercolor = function() {
			...
			if (me._rectangle_315.ggCurrentLogicStateBorderColor != newLogicStateBorderColor) {
				...
				if (me._rectangle_315.ggCurrentLogicStateBorderColor == 0) {
					me._rectangle_315.style.borderColor="rgba(50,180,182,1)";
				}
				else {
		...
		me._rectangle_313.logicBlock_bordercolor = function() {
			...
			if (me._rectangle_313.ggCurrentLogicStateBorderColor != newLogicStateBorderColor) {
				...
				if (me._rectangle_313.ggCurrentLogicStateBorderColor == 0) {
					me._rectangle_313.style.borderColor="rgba(50,180,182,1)";
				}
				else {
		...
		me._rectangle_311.logicBlock_bordercolor = function() {
			...
			if (me._rectangle_311.ggCurrentLogicStateBorderColor != newLogicStateBorderColor) {
				...
				if (me._rectangle_311.ggCurrentLogicStateBorderColor == 0) {
					me._rectangle_311.style.borderColor="rgba(50,180,182,1)";
				}
				else {
		...
		el=me._x6=document.createElement('div');
		el.ggId="x6";
		el.ggDx=0;
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		...
		me._x6.logicBlock_scaling = function() {
			var newLogicStateScaling;
			if (
				((me.elementMouseDown['x6'] == true))
			)
			{
				newLogicStateScaling = 0;
			}
			...
			if (me._x6.ggCurrentLogicStateScaling != newLogicStateScaling) {
				me._x6.ggCurrentLogicStateScaling = newLogicStateScaling;
				me._x6.style[domTransition]='' + cssPrefix + 'transform 200ms ease 0ms';
				if (me._x6.ggCurrentLogicStateScaling == 0) {
					me._x6.ggParameter.sx = 0.9;
					me._x6.ggParameter.sy = 0.9;
					me._x6.style[domTransform]=parameterToTransform(me._x6.ggParameter);
				}
				else {
					me._x6.ggParameter.sx = 1;
					me._x6.ggParameter.sy = 1;
					me._x6.style[domTransform]=parameterToTransform(me._x6.ggParameter);
				}
			}
		}
		me._x6.onclick=function (e) {
			player.setVariableValue('hidros', Number("6"));
		}
		me._x6.onmouseout=function (e) {
			me.elementMouseDown['x6']=false;
			me._x6.logicBlock_scaling();
		}
		me._x6.onmousedown=function (e) {
			me.elementMouseDown['x6']=true;
			me._x6.logicBlock_scaling();
		}
		me._x6.onmouseup=function (e) {
			me.elementMouseDown['x6']=false;
			me._x6.logicBlock_scaling();
		}
		me._x6.ontouchend=function (e) {
			me.elementMouseDown['x6']=false;
			me._x6.logicBlock_scaling();
		}
		me._x6.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._text_111.logicBlock_textcolor = function() {
			...
			if (
				((player.getVariableValue('hidros') == 6))
			)
			{
			...
			if (me._text_111.ggCurrentLogicStateTextColor != newLogicStateTextColor) {
				...
				if (me._text_111.ggCurrentLogicStateTextColor == 0) {
					me._text_111__text.style.color="rgba(50,180,182,1)";
				}
				else {
		...
		me._x6.appendChild(me._text_111);
		...
		me._rectangle_310.logicBlock_bordercolor = function() {
			...
			if (me._rectangle_310.ggCurrentLogicStateBorderColor != newLogicStateBorderColor) {
				...
				if (me._rectangle_310.ggCurrentLogicStateBorderColor == 0) {
					me._rectangle_310.style.borderColor="rgba(50,180,182,1)";
				}
				else {
		...
		me._x6.appendChild(me._rectangle_310);
		me._hidros0.appendChild(me._x6);
		...
		me._rectangle_39.logicBlock_bordercolor = function() {
			...
			if (me._rectangle_39.ggCurrentLogicStateBorderColor != newLogicStateBorderColor) {
				...
				if (me._rectangle_39.ggCurrentLogicStateBorderColor == 0) {
					me._rectangle_39.style.borderColor="rgba(50,180,182,1)";
				}
				else {
		...
		me._no3.appendChild(me._rectangle_39);
		...
		hs='data:image/svg+xml;base64,'+
			''+
			'';
		...
		me._text_110.logicBlock_textcolor = function() {
			...
			if (me._text_110.ggCurrentLogicStateTextColor != newLogicStateTextColor) {
				...
				if (me._text_110.ggCurrentLogicStateTextColor == 0) {
					me._text_110__text.style.color="rgba(50,180,182,1)";
				}
				else {
		...
		me._rectangle_38.logicBlock_bordercolor = function() {
			...
			if (me._rectangle_38.ggCurrentLogicStateBorderColor != newLogicStateBorderColor) {
				...
				if (me._rectangle_38.ggCurrentLogicStateBorderColor == 0) {
					me._rectangle_38.style.borderColor="rgba(50,180,182,1)";
				}
				else {
		...
		me.__2.appendChild(me._rectangle_38);
		...
		me._rectangle_37.logicBlock_bordercolor = function() {
			...
			if (me._rectangle_37.ggCurrentLogicStateBorderColor != newLogicStateBorderColor) {
				...
				if (me._rectangle_37.ggCurrentLogicStateBorderColor == 0) {
					me._rectangle_37.style.borderColor="rgba(50,180,182,1)";
				}
				else {
		...
		me._rectangle_36.logicBlock_bordercolor = function() {
			...
			if (me._rectangle_36.ggCurrentLogicStateBorderColor != newLogicStateBorderColor) {
				...
				if (me._rectangle_36.ggCurrentLogicStateBorderColor == 0) {
					me._rectangle_36.style.borderColor="rgba(50,180,182,1)";
				}
				else {
		...
		me._rectangle_35.logicBlock_bordercolor = function() {
			...
			if (me._rectangle_35.ggCurrentLogicStateBorderColor != newLogicStateBorderColor) {
				...
				if (me._rectangle_35.ggCurrentLogicStateBorderColor == 0) {
					me._rectangle_35.style.borderColor="rgba(50,180,182,1)";
				}
				else {
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		me._rectangle_34.logicBlock_bordercolor = function() {
			...
			if (me._rectangle_34.ggCurrentLogicStateBorderColor != newLogicStateBorderColor) {
				...
				if (me._rectangle_34.ggCurrentLogicStateBorderColor == 0) {
					me._rectangle_34.style.borderColor="rgba(50,180,182,1)";
				}
				else {
		...
		me._rectangle_33.logicBlock_bordercolor = function() {
			...
			if (me._rectangle_33.ggCurrentLogicStateBorderColor != newLogicStateBorderColor) {
				...
				if (me._rectangle_33.ggCurrentLogicStateBorderColor == 0) {
					me._rectangle_33.style.borderColor="rgba(50,180,182,1)";
				}
				else {
		...
		me._rectangle_32.logicBlock_bordercolor = function() {
			...
			if (me._rectangle_32.ggCurrentLogicStateBorderColor != newLogicStateBorderColor) {
				...
				if (me._rectangle_32.ggCurrentLogicStateBorderColor == 0) {
					me._rectangle_32.style.borderColor="rgba(50,180,182,1)";
				}
				else {
		...
		me._rectangle_31.logicBlock_bordercolor = function() {
			...
			if (me._rectangle_31.ggCurrentLogicStateBorderColor != newLogicStateBorderColor) {
				...
				if (me._rectangle_31.ggCurrentLogicStateBorderColor == 0) {
					me._rectangle_31.style.borderColor="rgba(50,180,182,1)";
				}
				else {
		...
		me._basic.logicBlock_bordercolor = function() {
			...
			if (me._basic.ggCurrentLogicStateBorderColor != newLogicStateBorderColor) {
				...
				if (me._basic.ggCurrentLogicStateBorderColor == 0) {
					me._basic.style.borderColor="rgba(50,180,182,1)";
				}
				else {
		...
		me._text_19.logicBlock_textcolor = function() {
			...
			if (me._text_19.ggCurrentLogicStateTextColor != newLogicStateTextColor) {
				...
				if (me._text_19.ggCurrentLogicStateTextColor == 0) {
					me._text_19__text.style.color="rgba(50,180,182,1)";
				}
				else {
		...
		me._full.logicBlock_bordercolor = function() {
			...
			if (me._full.ggCurrentLogicStateBorderColor != newLogicStateBorderColor) {
				...
				if (me._full.ggCurrentLogicStateBorderColor == 0) {
					me._full.style.borderColor="rgba(50,180,182,1)";
				}
				else {
		...
		me._text_18.logicBlock_textcolor = function() {
			...
			if (me._text_18.ggCurrentLogicStateTextColor != newLogicStateTextColor) {
				...
				if (me._text_18.ggCurrentLogicStateTextColor == 0) {
					me._text_18__text.style.color="rgba(50,180,182,1)";
				}
				else {
		...
		el=me._agarraderas0=document.createElement('div');
		el.ggId="agarraderas";
		el.ggDx=0;
		el.ggParameter={ rx:0,ry:0,a:0,sx:0,sy:0 };
		el.ggVisible=true;
		...
		el.style[domTransform + 'Origin']='50% 50%';
		el.style[domTransform]=parameterToTransform(el.ggParameter);
		me._agarraderas0.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._agarraderas0.logicBlock_scaling = function() {
			var newLogicStateScaling;
			if (
				((player.getVariableValue('configurador') == "agarraderas"))
			)
			{
				newLogicStateScaling = 0;
			}
			...
			if (me._agarraderas0.ggCurrentLogicStateScaling != newLogicStateScaling) {
				me._agarraderas0.ggCurrentLogicStateScaling = newLogicStateScaling;
				me._agarraderas0.style[domTransition]='' + cssPrefix + 'transform 500ms ease 0ms';
				if (me._agarraderas0.ggCurrentLogicStateScaling == 0) {
					me._agarraderas0.ggParameter.sx = 1;
					me._agarraderas0.ggParameter.sy = 1;
					me._agarraderas0.style[domTransform]=parameterToTransform(me._agarraderas0.ggParameter);
				}
				else {
					me._agarraderas0.ggParameter.sx = 0;
					me._agarraderas0.ggParameter.sy = 0;
					me._agarraderas0.style[domTransform]=parameterToTransform(me._agarraderas0.ggParameter);
				}
			}
		}
		me._agarraderas0.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._no.onclick=function (e) {
			player.setVariableValue('agarraderas', false);
		}
		...
		me._rectangle_30.logicBlock_bordercolor = function() {
			var newLogicStateBorderColor;
			if (
				((player.getVariableValue('agarraderas') == false))
			)
			{
				newLogicStateBorderColor = 0;
			}
			...
			if (me._rectangle_30.ggCurrentLogicStateBorderColor != newLogicStateBorderColor) {
				...
				if (me._rectangle_30.ggCurrentLogicStateBorderColor == 0) {
					me._rectangle_30.style.borderColor="rgba(50,180,182,1)";
				}
				else {
		...
		me._agarraderas0.appendChild(me._no);
		...
		me._si.onclick=function (e) {
			player.setVariableValue('agarraderas', true);
		}
		...
		me._rectangle_3.logicBlock_bordercolor = function() {
			var newLogicStateBorderColor;
			if (
				((player.getVariableValue('agarraderas') == true))
			)
			{
				newLogicStateBorderColor = 0;
			}
			...
			if (me._rectangle_3.ggCurrentLogicStateBorderColor != newLogicStateBorderColor) {
				...
				if (me._rectangle_3.ggCurrentLogicStateBorderColor == 0) {
					me._rectangle_3.style.borderColor="rgba(50,180,182,1)";
				}
				else {
		...
		me._agarraderas0.appendChild(me._si);
		me._configurador.appendChild(me._agarraderas0);
		...
		me._color.appendChild(me._image_26);
		...
		me._hidros.appendChild(me._image_25);
		...
		me._luces.appendChild(me._image_24);
		...
		me._blower.appendChild(me._image_23);
		...
		me._cascada.appendChild(me._image_22);
		...
		me._cabeceros.appendChild(me._image_21);
		...
		el=me._agarraderas=document.createElement('div');
		el.ggId="agarraderas";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_rectangle ";
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._agarraderas.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._agarraderas.logicBlock_scaling = function() {
			var newLogicStateScaling;
			if (
				((me.elementMouseDown['agarraderas'] == true))
			)
			{
				newLogicStateScaling = 0;
			}
			...
			if (me._agarraderas.ggCurrentLogicStateScaling != newLogicStateScaling) {
				me._agarraderas.ggCurrentLogicStateScaling = newLogicStateScaling;
				me._agarraderas.style[domTransition]='' + cssPrefix + 'transform 200ms ease 0ms';
				if (me._agarraderas.ggCurrentLogicStateScaling == 0) {
					me._agarraderas.ggParameter.sx = 0.9;
					me._agarraderas.ggParameter.sy = 0.9;
					me._agarraderas.style[domTransform]=parameterToTransform(me._agarraderas.ggParameter);
				}
				else if (me._agarraderas.ggCurrentLogicStateScaling == 1) {
					me._agarraderas.ggParameter.sx = 0.5;
					me._agarraderas.ggParameter.sy = 0.5;
					me._agarraderas.style[domTransform]=parameterToTransform(me._agarraderas.ggParameter);
				}
				else {
					me._agarraderas.ggParameter.sx = 1;
					me._agarraderas.ggParameter.sy = 1;
					me._agarraderas.style[domTransform]=parameterToTransform(me._agarraderas.ggParameter);
				}
			}
		}
		me._agarraderas.onmouseout=function (e) {
			me.elementMouseDown['agarraderas']=false;
			me._agarraderas.logicBlock_scaling();
		}
		me._agarraderas.onmousedown=function (e) {
			me.elementMouseDown['agarraderas']=true;
			me._agarraderas.logicBlock_scaling();
		}
		me._agarraderas.onmouseup=function (e) {
			me.elementMouseDown['agarraderas']=false;
			me._agarraderas.logicBlock_scaling();
		}
		me._agarraderas.ontouchend=function (e) {
			me.elementMouseDown['agarraderas']=false;
			me._agarraderas.logicBlock_scaling();
		}
		me._agarraderas.ggUpdatePosition=function (useTransition) {
		}
		...
		me._agarraderas.appendChild(me._activo0);
		...
		me._inactivo0.onclick=function (e) {
			player.setVariableValue('configurador', "agarraderas");
			player.moveTo("0","-20","35","3.0000");
		}
		...
		me._agarraderas.appendChild(me._inactivo0);
		...
		hs='data:image/png;base64,'+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			'a80N9CIJtc2neSkJEjAWTRkqQI1JwCnIsNFJWHNM1tD/BJtP83tNtCMXylQBanQAeyO57r+COJ+64G0kjdqzSL6j2v+XI0/7oKSMFaCeKrLP8ccRf4MZyOzYGGCscW4vkiv3JaRQzdd26Z/mNJS9AjRic+Q3dpMiKaLH4/EMbv4PfWwyQrb36doAAAAASUVORK5CYII=';
		els.setAttribute('src',hs);
		els.ggNormalSrc=hs;
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;');
		els.className='ggskin ggskin_image';
		...
		me._agarraderas.appendChild(me._image_20);
		...
		me._agarraderas.appendChild(me._text_11);
		me._scrollarea_1__content.appendChild(me._agarraderas);
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			''+
			'';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			'MS4zMzU5MzggMC0xMS43NzM0MzctOS41NTg1OTQtMjEuMzMyMDMxLTIxLjMzNTkzOC0yMS4zMzIwMzF6bTAgMCIgZGF0YS1vbGRfY29sb3I9IiMwMDAwMDAiLz4KIDwvZz4KPC9zdmc+Cg==';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			''+
			''+
			''+
			'';
		...
		hs_playhead += 'background-color: rgba(0,125,129,1);';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			...
			'Zz4KIDxnIGlkPSJMYXllcl8yIj4KICA8cGF0aCBmaWxsLW9wYWNpdHk9IjEiIGZpbGw9IiMwMDdkODEiIGQ9Ik0tMTkxLDM3MGMwLTEuNSwxLTIuMSwyLjMtMS4ybDM4LjIsMjYuNmMxLjMsMC45LDEuMywyLjMsMCwzLjJsLTM4LjIsMjYuNmMtMS4zLDAuOS0yLjMsMC4zLTIuMy0xLjJWMzcweiIvPgogPC9nPgo8L3N2Zz4K';
		...
		hs='data:image/svg+xml;base64,'+
			...
			'eiIvPgogPC9nPgogPGcgaWQ9IkxheWVyXzIiPgogIDxwYXRoIGZpbGwtb3BhY2l0eT0iMSIgZmlsbD0iIzAwN2Q4MSIgZD0iTS0xOTIuOCwzNjdjMC0xLjcsMS4yLTIuMywyLjYtMS4zbDQyLjQsMjkuNmMxLjQsMSwxLjQsMi42LDAsMy42bC00Mi40LDI5LjZjLTEuNCwxLTIuNiwwLjQtMi42LTEuM1YzNjd6Ii8+CiA8L2c+Cjwvc3ZnPgo=';
		...
		hs='data:image/svg+xml;base64,'+
			...
			''+
			'';
		...
		hs='data:image/svg+xml;base64,'+
			...
			''+
			'';
	...
	me.callChildLogicBlocksHotspot_variaciones_changenode = function(){
		if(hotspotTemplates['variaciones']) {
			...
			for(i = 0; i < hotspotTemplates['variaciones'].length; i++) {
				...
				if (hotspotTemplates['variaciones'][i]._agarraderas1 && hotspotTemplates['variaciones'][i]._agarraderas1.logicBlock_alpha) {
					hotspotTemplates['variaciones'][i]._agarraderas1.logicBlock_alpha();
				}
				...
				if (hotspotTemplates['variaciones'][i].__22 && hotspotTemplates['variaciones'][i].__22.logicBlock_alpha) {
					hotspotTemplates['variaciones'][i].__22.logicBlock_alpha();
				}
				if (hotspotTemplates['variaciones'][i].__10 && hotspotTemplates['variaciones'][i].__10.logicBlock_alpha) {
					hotspotTemplates['variaciones'][i].__10.logicBlock_alpha();
				}
				...
				if (hotspotTemplates['variaciones'][i].__4 && hotspotTemplates['variaciones'][i].__4.logicBlock_alpha) {
					hotspotTemplates['variaciones'][i].__4.logicBlock_alpha();
				}
	...
	me.callChildLogicBlocksHotspot_variaciones_varchanged_agarraderas = function(){
		if(hotspotTemplates['variaciones']) {
			var i;
			for(i = 0; i < hotspotTemplates['variaciones'].length; i++) {
				if (hotspotTemplates['variaciones'][i]._agarraderas1 && hotspotTemplates['variaciones'][i]._agarraderas1.logicBlock_alpha) {
	...
	function SkinHotspotClass_variaciones(parentScope,hotspot) {
		...
		els.className='ggskin ggskin_external';
		els.setAttribute('style','position: absolute;-webkit-user-drag:none;pointer-events:none;;');
		els.onload=function() {me.__22.ggUpdatePosition();}
		el.ggText=basePath + "assets/hidros22.png";
		els.setAttribute('src', el.ggText);
		els['ondragstart']=function() { return false; };
		player.checkLoaded.push(els);
		hs ='';
		...
		me.__22.logicBlock_alpha = function() {
			...
			if (me.__22.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				...
				me.__22.style[domTransition]='opacity 500ms ease 0ms';
				if (me.__22.ggCurrentLogicStateAlpha == 0) {
					me.__22.style.visibility=me.__22.ggVisible?'inherit':'hidden';
					me.__22.style.opacity=1;
				}
				else {
					setTimeout(function() { if (me.__22.style.opacity == 0.0) { me.__22.style.visibility="hidden"; } }, 505);
					me.__22.style.opacity=0;
				}
			}
		}
		me.__22.ggUpdatePosition=function (useTransition) {
			...
			var parentWidth = me.__22.clientWidth;
			var parentHeight = me.__22.clientHeight;
			var img = me.__22__img;
			var aspectRatioDiv = me.__22.clientWidth / me.__22.clientHeight;
			var aspectRatioImg = img.naturalWidth / img.naturalHeight;
			if (img.naturalWidth < parentWidth) parentWidth = img.naturalWidth;
			if (img.naturalHeight < parentHeight) parentHeight = img.naturalHeight;
			var currentWidth,currentHeight;
		...
		me._hidros1.appendChild(me.__22);
		el=me.__10=document.createElement('div');
		els=me.__10__img=document.createElement('img');
		els.className='ggskin ggskin_external';
		els.setAttribute('style','position: absolute;-webkit-user-drag:none;pointer-events:none;;');
		els.onload=function() {me.__10.ggUpdatePosition();}
		el.ggText=basePath + "assets/hidros10.png";
		els.setAttribute('src', el.ggText);
		els['ondragstart']=function() { return false; };
		player.checkLoaded.push(els);
		hs ='';
		...
		me.__10.logicBlock_alpha = function() {
			...
			if (me.__10.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				...
				me.__10.style[domTransition]='opacity 500ms ease 0ms';
				if (me.__10.ggCurrentLogicStateAlpha == 0) {
					me.__10.style.visibility=me.__10.ggVisible?'inherit':'hidden';
					me.__10.style.opacity=1;
				}
				else {
					setTimeout(function() { if (me.__10.style.opacity == 0.0) { me.__10.style.visibility="hidden"; } }, 505);
		...
		me.__10.ggUpdatePosition=function (useTransition) {
			...
			var parentWidth = me.__10.clientWidth;
			var parentHeight = me.__10.clientHeight;
			var img = me.__10__img;
			var aspectRatioDiv = me.__10.clientWidth / me.__10.clientHeight;
			var aspectRatioImg = img.naturalWidth / img.naturalHeight;
			if (img.naturalWidth < parentWidth) parentWidth = img.naturalWidth;
			if (img.naturalHeight < parentHeight) parentHeight = img.naturalHeight;
			var currentWidth,currentHeight;
		...
		me._hidros1.appendChild(me.__10);
		...
		els.className='ggskin ggskin_external';
		els.setAttribute('style','position: absolute;-webkit-user-drag:none;pointer-events:none;;');
		els.onload=function() {me.__4.ggUpdatePosition();}
		...
		me.__4.logicBlock_alpha = function() {
			var newLogicStateAlpha;
			if (
				((player.getVariableValue('luces') == 4)) && 
				((player.getVariableValue('luceson') == false))
			...
			if (me.__4.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				me.__4.ggCurrentLogicStateAlpha = newLogicStateAlpha;
				me.__4.style[domTransition]='opacity 500ms ease 0ms';
				if (me.__4.ggCurrentLogicStateAlpha == 0) {
					me.__4.style.visibility=me.__4.ggVisible?'inherit':'hidden';
					me.__4.style.opacity=1;
				}
				else {
					setTimeout(function() { if (me.__4.style.opacity == 0.0) { me.__4.style.visibility="hidden"; } }, 505);
		...
		me.__4.ggUpdatePosition=function (useTransition) {
			...
			var parentWidth = me.__4.clientWidth;
			var parentHeight = me.__4.clientHeight;
			var img = me.__4__img;
			var aspectRatioDiv = me.__4.clientWidth / me.__4.clientHeight;
			var aspectRatioImg = img.naturalWidth / img.naturalHeight;
			if (img.naturalWidth < parentWidth) parentWidth = img.naturalWidth;
			if (img.naturalHeight < parentHeight) parentHeight = img.naturalHeight;
			var currentWidth,currentHeight;
		...
		el=me._basico=document.createElement('div');
		els=me._basico__img=document.createElement('img');
		els.className='ggskin ggskin_external';
		els.setAttribute('style','position: absolute;-webkit-user-drag:none;pointer-events:none;;');
		els.onload=function() {me._basico.ggUpdatePosition();}
		el.ggText=basePath + "assets/basico.png";
		els.setAttribute('src', el.ggText);
		els['ondragstart']=function() { return false; };
		player.checkLoaded.push(els);
		hs ='';
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._basico.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._basico.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
			...
			var parentWidth = me._basico.clientWidth;
			var parentHeight = me._basico.clientHeight;
			var img = me._basico__img;
			var aspectRatioDiv = me._basico.clientWidth / me._basico.clientHeight;
			var aspectRatioImg = img.naturalWidth / img.naturalHeight;
			if (img.naturalWidth < parentWidth) parentWidth = img.naturalWidth;
			if (img.naturalHeight < parentHeight) parentHeight = img.naturalHeight;
			var currentWidth,currentHeight;
		...
		me._variaciones.appendChild(me._basico);
		el=me._agarraderas1=document.createElement('div');
		els=me._agarraderas1__img=document.createElement('img');
		els.className='ggskin ggskin_external';
		els.setAttribute('style','position: absolute;-webkit-user-drag:none;pointer-events:none;;');
		els.onload=function() {me._agarraderas1.ggUpdatePosition();}
		el.ggText=basePath + "assets/agarraderas.png";
		els.setAttribute('src', el.ggText);
		els['ondragstart']=function() { return false; };
		player.checkLoaded.push(els);
		hs ='';
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._agarraderas1.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._agarraderas1.logicBlock_alpha = function() {
			var newLogicStateAlpha;
			if (
				((player.getVariableValue('agarraderas') == true))
			)
			...
			if (me._agarraderas1.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				me._agarraderas1.ggCurrentLogicStateAlpha = newLogicStateAlpha;
				me._agarraderas1.style[domTransition]='opacity 500ms ease 0ms';
				if (me._agarraderas1.ggCurrentLogicStateAlpha == 0) {
					me._agarraderas1.style.visibility=me._agarraderas1.ggVisible?'inherit':'hidden';
					me._agarraderas1.style.opacity=1;
				}
				else {
					setTimeout(function() { if (me._agarraderas1.style.opacity == 0.0) { me._agarraderas1.style.visibility="hidden"; } }, 505);
					me._agarraderas1.style.opacity=0;
				}
			}
		}
		me._agarraderas1.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
			...
			var parentWidth = me._agarraderas1.clientWidth;
			var parentHeight = me._agarraderas1.clientHeight;
			var img = me._agarraderas1__img;
			var aspectRatioDiv = me._agarraderas1.clientWidth / me._agarraderas1.clientHeight;
			var aspectRatioImg = img.naturalWidth / img.naturalHeight;
			if (img.naturalWidth < parentWidth) parentWidth = img.naturalWidth;
			if (img.naturalHeight < parentHeight) parentHeight = img.naturalHeight;
			var currentWidth,currentHeight;
		...
		me._variaciones.appendChild(me._agarraderas1);
		me.ggUse3d=true;
	...
	me.addSkinHotspot=function(hotspot) {
		...
		} else
		{
			...
			me.callChildLogicBlocksHotspot_variaciones_varchanged_agarraderas();;
	...
	me._agarraderas0.logicBlock_scaling();
	...
	player.addListener('changenode', function(args) { me._parte_superior.logicBlock_position();me._responsive_configurador.logicBlock_position();me._configurador.logicBlock_position();me._color0.logicBlock_scaling();me._rectangle_317.logicBlock_bordercolor();me._rectangle_315.logicBlock_bordercolor();me._rectangle_313.logicBlock_bordercolor();me._rectangle_311.logicBlock_bordercolor();me._hidros0.logicBlock_scaling();me._text_111.logicBlock_textcolor();me._rectangle_310.logicBlock_bordercolor();me._luces0.logicBlock_scaling();me._rectangle_39.logicBlock_bordercolor();me._svg_53.logicBlock_alpha();me._text_110.logicBlock_textcolor();me._rectangle_38.logicBlock_bordercolor();me._rectangle_37.logicBlock_bordercolor();me._off0.logicBlock_visible();me._on1.logicBlock_visible();me._blower0.logicBlock_scaling();me._rectangle_36.logicBlock_bordercolor();me._svg_52.logicBlock_alpha();me._rectangle_35.logicBlock_bordercolor();me._svg_32.logicBlock_alpha();me._cabeceros0.logicBlock_scaling();me._rectangle_34.logicBlock_bordercolor();me._svg_51.logicBlock_alpha();me._rectangle_33.logicBlock_bordercolor();me._svg_31.logicBlock_alpha();me._cascada0.logicBlock_scaling();me._rectangle_32.logicBlock_bordercolor();me._svg_50.logicBlock_alpha();me._rectangle_31.logicBlock_bordercolor();me._svg_30.logicBlock_alpha();me._versiones0.logicBlock_scaling();me._basic.logicBlock_bordercolor();me._text_19.logicBlock_textcolor();me._full.logicBlock_bordercolor();me._text_18.logicBlock_textcolor();me._agarraderas0.logicBlock_scaling();me._rectangle_30.logicBlock_bordercolor();me._svg_5.logicBlock_alpha();me._rectangle_3.logicBlock_bordercolor();me._svg_3.logicBlock_alpha();me._color.logicBlock_scaling();me._activo6.logicBlock_visible();me._inactivo6.logicBlock_visible();me._hidros.logicBlock_scaling();me._activo5.logicBlock_visible();me._inactivo5.logicBlock_visible();me._luces.logicBlock_scaling();me._activo4.logicBlock_visible();me._inactivo4.logicBlock_visible();me._blower.logicBlock_scaling();me._activo3.logicBlock_visible();me._inactivo3.logicBlock_visible();me._cascada.logicBlock_scaling();me._activo2.logicBlock_visible();me._inactivo2.logicBlock_visible();me._cabeceros.logicBlock_scaling();me._activo1.logicBlock_visible();me._inactivo1.logicBlock_visible();me._agarraderas.logicBlock_scaling();me._activo0.logicBlock_visible();me._inactivo0.logicBlock_visible();me._activo.logicBlock_visible();me._inactivo.logicBlock_visible();me._svg_7.logicBlock_alpha();me._off.logicBlock_visible();me._on.logicBlock_visible();me._cta.logicBlock_position();me._hotspotson.logicBlock_position();me._hotspotson.logicBlock_scaling();me._hotspotson.logicBlock_angle();me._hotspotsoff.logicBlock_position();me._hotspotsoff.logicBlock_scaling();me._hotspotsoff.logicBlock_angle();me._ht_image.logicBlock_scaling();me._information_horiz.logicBlock_alpha();me._container_text0.logicBlock_size();me._information_vert.logicBlock_alpha();me._container_text.logicBlock_size();me._svg_4.logicBlock_angle();me._video_screentint_file.logicBlock_visible();me._video_popup_file.logicBlock_visible();me._popup_video_file.logicBlock_visible();me._text_3.logicBlock_visible();me._video_popup_controls_file.logicBlock_visible();me._ir_a_planta.logicBlock_position();me._ir_a_planta.logicBlock_scaling();me._ir_a_frontal.logicBlock_position();me._ir_a_frontal.logicBlock_scaling(); });
	...
	player.addListener('varchanged_agarraderas', function(args) { me._rectangle_30.logicBlock_bordercolor();me._svg_5.logicBlock_alpha();me._rectangle_3.logicBlock_bordercolor();me._svg_3.logicBlock_alpha(); });
	player.addListener('varchanged_configurador', function(args) { me._configurador.logicBlock_position();me._color0.logicBlock_scaling();me._hidros0.logicBlock_scaling();me._luces0.logicBlock_scaling();me._blower0.logicBlock_scaling();me._cabeceros0.logicBlock_scaling();me._cascada0.logicBlock_scaling();me._versiones0.logicBlock_scaling();me._agarraderas0.logicBlock_scaling();me._activo6.logicBlock_visible();me._inactivo6.logicBlock_visible();me._activo5.logicBlock_visible();me._inactivo5.logicBlock_visible();me._activo4.logicBlock_visible();me._inactivo4.logicBlock_visible();me._activo3.logicBlock_visible();me._inactivo3.logicBlock_visible();me._activo2.logicBlock_visible();me._inactivo2.logicBlock_visible();me._activo1.logicBlock_visible();me._inactivo1.logicBlock_visible();me._activo0.logicBlock_visible();me._inactivo0.logicBlock_visible();me._activo.logicBlock_visible();me._inactivo.logicBlock_visible();me._cta.logicBlock_position(); });
	...
	player.addListener('varchanged_hidros', function(args) { me._text_111.logicBlock_textcolor();me._rectangle_310.logicBlock_bordercolor();me._basic.logicBlock_bordercolor();me._text_19.logicBlock_textcolor();me._full.logicBlock_bordercolor();me._text_18.logicBlock_textcolor(); });
	player.addListener('varchanged_luces', function(args) { me._rectangle_39.logicBlock_bordercolor();me._svg_53.logicBlock_alpha();me._text_110.logicBlock_textcolor();me._rectangle_38.logicBlock_bordercolor();me._rectangle_37.logicBlock_bordercolor();me._basic.logicBlock_bordercolor();me._text_19.logicBlock_textcolor();me._full.logicBlock_bordercolor();me._text_18.logicBlock_textcolor(); });
	player.addListener('varchanged_luceson', function(args) { me._off0.logicBlock_visible();me._on1.logicBlock_visible(); });
	player.addListener('varchanged_versionesescalar', function(args) { me._color.logicBlock_scaling();me._hidros.logicBlock_scaling();me._luces.logicBlock_scaling();me._blower.logicBlock_scaling();me._cascada.logicBlock_scaling();me._cabeceros.logicBlock_scaling();me._agarraderas.logicBlock_scaling(); });
	...
	player.addListener('varchanged_agarraderas', function(args) { me.callChildLogicBlocksHotspot_variaciones_varchanged_agarraderas(); });
